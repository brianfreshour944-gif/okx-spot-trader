...
class GridBot:
    def __init__(self):
        ...
        self.exchange = ccxt.okx({
            ...
            'hostname': 'app.okx.com',  # Explicitly use US hostname
        ...
        # Determine if you are actually testing or trading live
        # If using real keys, do NOT set sandbox mode to True
